...
- [Android-PickerView-Library](https://github.com/Airsaid/Android-PickerView-Library) ★75 - 高仿 IOS PickerView 控件的库 
...
- [Alerter](https://github.com/Tapadoo/Alerter) ★2584 - 克服Toast和Snackbar的限制 
...
- [Android-BitherCompress](https://github.com/jeanboydev/Android-BitherCompress) ★268 - Android图片压缩目前最优解决方案 
...
- [KrGallery](https://github.com/chengzichen/KrGallery) ★25 - 图片处理库 

## 徽章(Badge) 

- [BGABadgeView-Android](https://github.com/bingoogolapple/BGABadgeView-Android) ★1661 - Android 徽章控件 
- [BadgeView](https://github.com/qstumn/BadgeView) ★1307 - 自由定制的BadgeView 
- [Android-ActionItemBadge](https://github.com/mikepenz/Android-ActionItemBadge) ★1088 - 为ActionItem添加标识 
- [MaterialBadgeTextView](https://github.com/matrixxun/MaterialBadgeTextView) ★875 - 展示新的信息标识和新的特色标识 
- [Badger](https://github.com/volders/Badger) ★705 - 添加徽章 
- [Badge](https://github.com/nekocode/Badge) ★559 - 一系列徽章图片 
- [BadgeView](https://github.com/AlexLiuSheng/BadgeView) ★467 - 基于Android的BadeView 
- [badgebutton](https://github.com/czy1121/badgebutton) ★342 - 带有徽标(数字，小红点)的按钮 
- [NotificationBadge](https://github.com/nex3z/NotificationBadge) ★83 - 带有动画的通知标记 
- [BadgeRadioButton](https://github.com/hcs-xph/BadgeRadioButton) ★25 - 仿QQ底部Tab切换RadioButton 
- [SuperBadge](https://github.com/chendongde310/SuperBadge) ★19 - 消息红点计数解决方案 

## RatingView 

- [MaterialRatingBar](https://github.com/DreaminginCodeZH/MaterialRatingBar) ★786 - 性能更好的MD风格的RatingBar 
- [SimpleRatingBar](https://github.com/FlyingPumba/SimpleRatingBar) ★625 - 简单但功能强大的RatingBar 
- [SpiderWebScoreView](https://github.com/xiaopansky/SpiderWebScoreView) ★571 - 蛛网评分控件 
- [SmileyRating](https://github.com/sujithkanna/SmileyRating) ★495 - Android简单的评级栏 
- [SimpleRatingBar](https://github.com/ome450901/SimpleRatingBar) ★286 - 一个简单的自定义动画的评分组件 
- [SimpleRatingView](https://github.com/xiprox/SimpleRatingView) ★167 - Android的评价切换 
- [AndroidCustomView](https://github.com/AllenCoder/AndroidCustomView) ★125 - 简单的投票排名对比图 
- [rating-request](https://github.com/iamhabib/rating-request) ★24 - 简单的Android对话框 

## 滚动效果(Scroll) 

- [Android-ObservableScrollView](https://github.com/ksoichiro/Android-ObservableScrollView) ★7522 - 观察滚动事件和滚动视图的Android库 
- [AndroidScrollingImageView](https://github.com/Q42/AndroidScrollingImageView) ★1195 - 安卓视差动画效果 
- [Scrollable](https://github.com/noties/Scrollable) ★872 - 封装实现滚动条的滚动逻辑 
- [material-scrolling](https://github.com/satorufujiwara/material-scrolling) ★579 - MD风格的滚动效果安卓库 
- [MaterialScrollBar](https://github.com/turing-tech/MaterialScrollBar) ★565 - 为MD5.1之前的版本带来MD5.1的滚动条 
- [ScrollLayout](https://github.com/yingLanNull/ScrollLayout) ★209 - 场景抽屉拖拽效果 
- [HVScrollView](https://github.com/LuckyJayce/HVScrollView) ★44 - 配置水平和垂直滚动的HVScrollView 

## 时间轴 

- [Timeline-View](https://github.com/vipulasri/Timeline-View) ★1159 - 时间线视图库 
- [TimelineView](https://github.com/alorma/TimelineView) ★884 - 在应用程序添加时间轴的安卓视图 
- [TimelineView](https://github.com/qapqap/TimelineView) ★404 - Android自定义时间线视图 
- [UnderLineLinearLayout](https://github.com/razerdp/UnderLineLinearLayout) ★269 - 一个简单的时间轴实现 
- [TimeLine](https://github.com/vienan/TimeLine) ★251 - 安卓时间轴 

## TreeView 

- [AndroidTreeView](https://github.com/bmelnychuk/AndroidTreeView) ★1667 - 安卓的目录视图 
- [RecyclerTreeView](https://github.com/TellH/RecyclerTreeView) ★162 - 安卓的TreeView实现 
- [TreeView](https://github.com/shineM/TreeView) ★87 - 树形结构组件 

## SearchView 

- [MaterialSearchView](https://github.com/MiguelCatalan/MaterialSearchView) ★2154 - 以MD风格实现SearchView 
- [floatingsearchview](https://github.com/arimorty/floatingsearchview) ★2012 - 带有搜索建议的浮动搜索栏 
- [JJSearchViewAnim](https://github.com/android-cjj/JJSearchViewAnim) ★1952 - 炫酷的SearchView搜索动画库 
- [SearchView](https://github.com/lapism/SearchView) ★1521 - 类似Play Store的SearchView 
- [FloatingSearchView](https://github.com/renaudcerrato/FloatingSearchView) ★1214 - 浮动的搜索视图实现 
- [MaterialSearchBar](https://github.com/mancj/MaterialSearchBar) ★991 - 安卓MD风格搜索栏 
- [Search-View-Layout](https://github.com/sahildave/Search-View-Layout) ★887 - Lollipop+ Dialer和Google Maps的实现 
- [MaterialSearchView](https://github.com/Mauker1/MaterialSearchView) ★725 - 基于MD风格的Android搜索视图 
- [Material-SearchTransition](https://github.com/alexstyl/Material-SearchTransition) ★323 - 展示如何过渡到搜索的示例项目 
- [QueryHighlighter](https://github.com/cyrilmottier/QueryHighlighter) ★253 - 在文本中突出搜索字词 
- [searchablespinner](https://github.com/michaelprimez/searchablespinner) ★94 - 搜索器 
- [MsvSearch](https://github.com/claudiodegio/MsvSearch) ★91 - Material Design风格搜索视图 
- [SearchDialog](https://github.com/wenwenwen888/SearchDialog) ★79 - 仿bilibili搜索框效果 
- [LSearchView](https://github.com/onlynight/LSearchView) ★29 - Android L设计搜索视图 

## TagView 

- [ChipsLayoutManager](https://github.com/BelooS/ChipsLayoutManager) ★1648 - 自定义RecyclerView布局管理器 
- [FlowLayout](https://github.com/nex3z/FlowLayout) ★920 - 让子视图自动浮动到下一行 
- [SimpleTagImageView](https://github.com/wujingchao/SimpleTagImageView) ★816 - 安卓中带有标签的ImageView 
- [AndroidTagView](https://github.com/whilu/AndroidTagView) ★779 - Android TagView库 
- [materialChipView](https://github.com/robertlevonyan/materialChipView) ★676 - MD风格的Chip视图 
- [AutoLabelUI](https://github.com/DavidPizarro/AutoLabelUI) ★590 - 将标签并排放置的Android库 
- [android-tagview](https://github.com/kaedea/android-tagview) ★577 - 云标签控件 
- [TriangleRectangleLabelView](https://github.com/Frank-Zhu/TriangleRectangleLabelView) ★446 - 标签视图 
- [TagViewGroup](https://github.com/shellljx/TagViewGroup) ★412 - Android 仿小红书图片标签 
- [EasyTagDragView](https://github.com/wenhuaijun/EasyTagDragView) ★221 - 仿网易新闻app下拉标签选择菜单 
- [ChannelTagView](https://github.com/yilylong/ChannelTagView) ★49 - 一个频道管理view 
- [LaybelLayout](https://github.com/paulyung541/LaybelLayout) ★22 - 标签布局 
- [FlowLayoutDemo](https://github.com/PingerOne/FlowLayoutDemo) ★21 - 自定义View实现流式布局 

## TextView 

- [HTextView](https://github.com/hanks-zyh/HTextView) ★3073 - 支持自定义字体的TextView动画效果 
- [android-autofittextview](https://github.com/grantland/android-autofittextview) ★2725 - 自动改变文字大小完美适应边界 
- [ticker](https://github.com/robinhood/ticker) ★2440 - 显示滚动文本 
- [ExpandableTextView](https://github.com/Manabu-GT/ExpandableTextView) ★2245 - 展开/折叠TextView 
- [TextJustify-Android](https://github.com/bluejamesbond/TextJustify-Android) ★1473 - 文本处理库 
- [RichText](https://github.com/zzhoujay/RichText) ★1411 - Android富文本解析器 
- [SlantedTextView](https://github.com/HeZaiJin/SlantedTextView) ★1239 - 倾斜的TextView 
- [SuperTextView](https://github.com/lygttpod/SuperTextView) ★1213 - 功能强大的TextView 
- [Android-TextView-LinkBuilder](https://github.com/klinker24/Android-TextView-LinkBuilder) ★1143 - 创建可点击的链接 
- [TextLayoutBuilder](https://github.com/facebookincubator/TextLayoutBuilder) ★1116 - Facebook出品的在Android中轻松实现文字布局 
- [ReadMoreTextView](https://github.com/borjabravo10/ReadMoreTextView) ★1047 - 装饰文本的自定义TextView 
- [TokenAutoComplete](https://github.com/splitwise/TokenAutoComplete) ★968 - 安卓Gmail风格的MultiAutoCompleteTextView 
- [SuperTextView](https://github.com/chenBingX/SuperTextView) ★941 - 提高构建项目的效率 
- [html-textview](https://github.com/SufficientlySecure/html-textview) ★870 - 扩展的安卓TextView组件 
- [FadingTextView](https://github.com/rosenpin/FadingTextView) ★834 - 自动改变其内容的TextView 
- [AutoLinkTextView](https://github.com/armcha/AutoLinkTextView) ★832 - 自动检测并处理点击事件 
- [Android-RobotoTextView](https://github.com/johnkil/Android-RobotoTextView) ★758 - TextView及其直接间接子类的实现 
- [AutoFitTextView](https://github.com/AndroidDeveloperLB/AutoFitTextView) ★668 - 自动适应字体和行计数的TextView 
- [BabushkaText](https://github.com/quiqueqs/BabushkaText) ★658 - 通过Spannables设置文本样式 
...
- [android-justifiedtextview](https://github.com/ufo22940268/android-justifiedtextview) ★576 - 基于原生TextView实现合理的textview 
- [Trestle](https://github.com/lawloretienne/Trestle) ★542 - 在TextView上桥接span 
- [android-chips](https://github.com/klinker41/android-chips) ★529 - 基于Google的内部chip库的简易库 
- [ExpandableTextView](https://github.com/Chen-Sir/ExpandableTextView) ★487 - 展开折叠TextView 
- [Markdown](https://github.com/zzhoujay/Markdown) ★475 - Android原生Markdown解析器 
- [html-builder](https://github.com/jrummyapps/html-builder) ★430 - 为Android TextView建立有效的HTML 
- [SimpleText](https://github.com/jaychang0917/SimpleText) ★420 - 简化spannable字符串的创建 
- [dante](https://github.com/fourlastor/dante) ★415 - 文本解析器 
- [AvatarLabelView](https://github.com/yanbober/AvatarLabelView) ★413 - 可配置的迷你版轻量级 Label 辅助类 
- [cornerlabelview](https://github.com/czy1121/cornerlabelview) ★391 - 视图角标 
- [NumberAnimTextView](https://github.com/Bakumon/NumberAnimTextView) ★370 - 数字增加动画的 TextView 
- [text-decorator](https://github.com/nntuyen/text-decorator) ★365 - 轻松装饰TextView 
- [UnderLineLinkTextView](https://github.com/wangshaolei/UnderLineLinkTextView) ★327 - 使关键词带有可点击的下划线TextView 
- [XRichText](https://github.com/limedroid/XRichText) ★272 - 显示Html富文本的TextView 
- [PinchZoomTextView](https://github.com/androidessence/PinchZoomTextView) ★270 - 用手势缩放字体大小 
- [Better-Link-Movement-Method](https://github.com/Saketme/Better-Link-Movement-Method) ★226 - 在TextView中处理RUL 
- [ColorTextView](https://github.com/zhonghanwen/ColorTextView) ★213 - 用颜色标记一些短语 
- [FlexibleRichTextView](https://github.com/daquexian/FlexibleRichTextView) ★198 - 自行定义大部分标签 
- [GetWordTextView](https://github.com/burgessjp/GetWordTextView) ★165 - 通过点击获得词语 
- [MoreTextView](https://github.com/Xander1024/MoreTextView) ★121 - TextView的“展开”和“收起” 
- [CharCountTextView](https://github.com/xbroak/CharCountTextView) ★114 - 仿Twitter剩余长度计数器 
- [TagEditText](https://github.com/limedroid/TagEditText) ★113 - 显示类似微博中的活动标签 
- [RandomTextView](https://github.com/AndroidMsky/RandomTextView) ★111 - 滚动显示TextView的数字 
- [RickText](https://github.com/CarGuo/RickText) ★89 - 类似微博的编辑框 
- [nachos](https://github.com/hootsuite/nachos) ★54 - 输入文本并创建MD风格的chip 
...
- [RichTextView](https://github.com/githubwing/RichTextView) ★36 - 富文本textview 
- [TextViewDrawable](https://github.com/ithedan/TextViewDrawable) ★34 - 仿大众点评的购买须知 
...
- [MaterialEditText](https://github.com/rengwuxian/MaterialEditText) ★4151 - MD风格的EditText 
- [Android Form EditText](https://github.com/vekexasia/android-edittext-validator) ★1229 - 为edittext带来数据有效性工具 
- [MaterialTextField](https://github.com/florent37/MaterialTextField) ★1013 - 与众不同的漂亮的浮动可编辑文本框 
- [BufferTextInputLayout](https://github.com/bufferapp/BufferTextInputLayout) ★808 - 简单的TextImputLayout定制化服务 
- [BiuEditText](https://github.com/xujinyang/BiuEditText) ★598 - 一个有趣的EditText 
- [MentionEditText](https://github.com/luckyandyzhang/MentionEditText) ★347 - 为提及的字符串添加一些有用的功能特色 
- [AndroidEdit](https://github.com/qinci/AndroidEdit) ★333 - EditText的撤销和恢复撤销操作 
- [TyperEditText](https://github.com/andyxialm/TyperEditText) ★310 - 打字机效果 
- [AnFQNumEditText](https://github.com/FTandJYQ/AnFQNumEditText) ★249 - 自定义EditText实现右下角计数控件 
- [AutoFillEmailEditText](https://github.com/wangshaolei/AutoFillEmailEditText) ★245 - 自动对EditText添加自定义email 
- [LineHeightEditText](https://github.com/hanks-zyh/LineHeightEditText) ★137 - 修复文本编辑行高和光标效果 
- [PowerfulViewLibrary](https://github.com/chaychan/PowerfulViewLibrary) ★83 - 输入框功能 
- [EditCard](https://github.com/Morxander/EditCard) ★78 - 输入信用卡号码的自定义EditText 
- [FloatingEditText](https://github.com/rafakob/FloatingEditText) ★61 - TextInputLayout和TextInputEditText合并成一个类 
- [EasyMoney-Widgets](https://github.com/wajahatkarim3/EasyMoney-Widgets) ★31 - 支持货币显示的部件 
...
- [AndroidSlidingUpPanel](https://github.com/umano/AndroidSlidingUpPanel) ★6235 - 通过向上拖动添加额外面板 
- [SlideUp-Android](https://github.com/mancj/SlideUp-Android) ★1245 - 对任何视图添加边侧效果 
- [DiscreteSlider](https://github.com/lawloretienne/DiscreteSlider) ★540 - 让用户在指定的刻度线上选择一个值的滑块 
- [slideview](https://github.com/MAXDeliveryNG/slideview) ★480 - 简单独特的Android滑动按钮 
- [SlidingLayout](https://github.com/HomHomLin/SlidingLayout) ★343 - 安卓平台View控件 
- [SlidingBall](https://github.com/dalong982242260/SlidingBall) ★197 - 仿QQ身边的人的效果 

## 表单 

- [android-saripaar](https://github.com/ragunathjawahar/android-saripaar) ★2267 - 基于规则的AndroidUI输入验证库 
- [hover](https://github.com/google/hover) ★2011 - Android浮动菜单实现 
- [MaterialLogin](https://github.com/fanrunqi/MaterialLogin) ★1500 - MD风格的登录效果 
- [MaterialChipsInput](https://github.com/pchmn/MaterialChipsInput) ★1371 - MD风格chip组件的实现 
- [GridPasswordView](https://github.com/Jungerr/GridPasswordView) ★1253 - Android密码视图 
- [AndroidKeyboardWatcher](https://github.com/AzimoLabs/AndroidKeyboardWatcher) ★768 - Android可开闭输入键盘 
- [AwesomeValidation](https://github.com/thyrlian/AwesomeValidation) ★743 - 实现对Android的验证 
- [MaterialLogin](https://github.com/shem8/MaterialLogin) ★691 - MD风格的登录注册视图 
- [passwordview](https://github.com/lisawray/passwordview) ★663 - Android密码视图 
- [material-code-input](https://github.com/glomadrian/material-code-input) ★662 - MD样式的编码输入 
- [PasswordLoadingView](https://github.com/Rogero0o/PasswordLoadingView) ★536 - 当完成密码时显示一个动画 
- [OnePageSigninSignup](https://github.com/irfaan008/OnePageSigninSignup) ★441 - 单页面实现注册登录 
- [SwipeCaptcha](https://github.com/mcxtzhang/SwipeCaptcha) ★393 - Android 平台的滑动验证码 
- [data-binding-validator](https://github.com/Ilhasoft/data-binding-validator) ★219 - 使验证字段变得简单而快速 
- [Ratifier](https://github.com/Hamadakram/Ratifier) ★106 - Android表单验证库 
- [ValidationUtilsLibrary](https://github.com/sgaikar1/ValidationUtilsLibrary) ★91 - 实现表单验证 
- [social-login-helper](https://github.com/mukeshsolanki/social-login-helper) ★32 - 将社交登录整合到应用中 

## 分段控件 

- [android-segmented-control](https://github.com/Kaopiz/android-segmented-control) ★1334 - Android自定义视图 
- [SHSegmentControl](https://github.com/7heaven/SHSegmentControl) ★461 - 一个简单的SegmentControl部件 
...
- [Android-ConvenientBanner](https://github.com/saiwu-bigkoo/Android-ConvenientBanner) ★2663 - 通用的广告栏控件 
- [banner](https://github.com/youth5201314/banner) ★2471 - Android广告图片轮播控件 
- [BGABanner-Android](https://github.com/bingoogolapple/BGABanner-Android) ★1707 - 引导界面滑动导航 
- [android-pile-layout](https://github.com/xmuSistone/android-pile-layout) ★886 - 堆叠滑动控件 
- [carouselview](https://github.com/sayyam/carouselview) ★593 - Android轮播框库 
- [CarouselPicker](https://github.com/GoodieBag/CarouselPicker) ★453 - 轮播图选择器 
- [SuperIndicator](https://github.com/hejunlin2013/SuperIndicator) ★393 - 首页推荐位轮播图 
- [XBanner](https://github.com/xiaohaibin/XBanner) ★349 - 自定义图片无限轮播的控件 
- [BannerLayout](https://github.com/dongjunkun/BannerLayout) ★273 - 简洁实用的android广告栏 
- [bannerview](https://github.com/czy1121/bannerview) ★190 - 横幅广告图片轮播控件 
- [RecyclerViewBanner](https://github.com/loonggg/RecyclerViewBanner) ★159 - 使用RecyclerView做的轮播图 
- [AndroidCarrouselLayout](https://github.com/dalong982242260/AndroidCarrouselLayout) ★111 - 安卓轮播框布局 
- [Banner-Slider](https://github.com/saeedsh92/Banner-Slider) ★66 - 在Android应用中便于使用的精致滑块 
- [MaterialBanner](https://github.com/rtugeek/MaterialBanner) ★57 - MD风格的banner 
- [Flare](https://github.com/IntruderShanky/Flare) ★56 - 简单的循环指示器实现 
- [RecyclerBanner](https://github.com/13456961183/RecyclerBanner) ★27 - 使用RecyclerView 实现的轮播图 
- [simplebanner](https://github.com/genius158/simplebanner) ★16 - 基于adapter的轮播图实现 

## 文件操作 

- [Android Upload Service](https://github.com/gotev/android-upload-service) ★1192 - 轻松实现后台上传文件 
- [AmazeFileManager](https://github.com/arpitkh96/AmazeFileManager) ★1172 - 好用的文件管理源代码 
- [Android-FilePicker](https://github.com/DroidNinja/Android-FilePicker) ★1077 - 灵活选择图片和视频的文件选择器 
- [MaterialFilePicker](https://github.com/nbsp-team/MaterialFilePicker) ★602 - MD风格文件选择器库 
- [ThinDownloadManager](https://github.com/smanikandan14/ThinDownloadManager) ★596 - Android下载文件库 
- [NoNonsense-FilePicker](https://github.com/spacecowboy/NoNonsense-FilePicker) ★528 - 文件选择器库 
- [AndroidPDF](https://github.com/lidong1665/AndroidPDF) ★56 - PDF文件打开方法 
- [Android-FileBrowser-FilePicker](https://github.com/adityak368/Android-FileBrowser-FilePicker) ★25 - Android文件浏览器文件选择器 

## 启动页 

- [Welcome](https://github.com/stephentuso/welcome-android) ★1294 - 安卓欢迎屏效果 
- [Particle](https://github.com/JeasonWong/Particle) ★1042 - 酷炫动画效果 
- [WowSplash](https://github.com/githubwing/WowSplash) ★717 - 铁塔融云闪屏页 
- [AwesomeSplash](https://github.com/ViksaaSkool/AwesomeSplash) ★572 - 令人叫绝的可自定义的飞溅效果屏幕 
- [WelcomeVideoPager](https://github.com/linglongxin24/WelcomeVideoPager) ★87 - Android酷炫欢迎页播放视频 

## MD 

- [MaterialDesignLibrary](https://github.com/navasmdc/MaterialDesignLibrary) ★8160 - Material Design 安卓库 
- [RippleEffect](https://github.com/traex/RippleEffect) ★4204 - MD风格的点击涟漪效果实现 
- [material-ripple](https://github.com/balysv/material-ripple) ★1803 - Android视图的纹波效果封装 
- [Carbon](https://github.com/ZieIony/Carbon) ★1628 - Android的MD风格实现案例 
- [JFoenix](https://github.com/jfoenixadmin/JFoenix) ★1264 - 使用Java组件实现Google的MD风格 
- [MaterialValues](https://github.com/AoDevBlue/MaterialValues) ★709 - 将Material Design指南中的所有值在资源中定义 
- [RippleDrawable](https://github.com/ozodrukh/RippleDrawable) ★495 - Android<ripple>效果端口 
- [MaterialMasterDetail](https://github.com/lurbas/MaterialMasterDetail) ★238 - 实现Master及Detail模式 
- [RippleLayout](https://github.com/liuguangqiang/RippleLayout) ★206 - 实现波纹效果的布局 
- [material-element](https://github.com/takahirom/material-element) ★162 - MD风格动画示例APP 
- [MaterialTransitionAnimation](https://github.com/Cutta/MaterialTransitionAnimation) ★99 - MD风格动画实践 

## BottomNavigation 

- [BottomBar](https://github.com/roughike/BottomBar) ★6219 - 自定义视图组件 
- [NavigationTabBar](https://github.com/DevLight-Mobile-Agency/NavigationTabBar) ★3018 - 带有色彩交互的导航标签栏 
- [ahbottomnavigation](https://github.com/aurelhubert/ahbottomnavigation) ★2044 - 实现MD风格的按钮导航组件库 
- [BottomNavigation](https://github.com/Ashok-Varma/BottomNavigation) ★1975 - 从GooglePlay商店获取示例apk 
- [Space-Navigation-View](https://github.com/armcha/Space-Navigation-View) ★1274 - 仿GoogleSpaces的导航完全整合 
- [Material-BottomNavigation](https://github.com/sephiroth74/Material-BottomNavigation) ★891 - 轻量级底部导航库组件 
- [LuseenBottomNavigation](https://github.com/armcha/LuseenBottomNavigation) ★838 - 底部导航视图 
- [AlphaTabsIndicator](https://github.com/yingLanNull/AlphaTabsIndicator) ★467 - 高仿微信底部状态栏的轻量级库 
- [AdaptableBottomNavigation](https://github.com/bufferapp/AdaptableBottomNavigation) ★417 - 又一个Bottom Navigation实现 
- [JPTabBar](https://github.com/peng8350/JPTabBar) ★405 - 安卓标签栏 
- [BottomNavigationViewEx](https://github.com/ittianyu/BottomNavigationViewEx) ★384 - 增强BottomNavigationView的安卓库 
- [BottomNavigationBar](https://github.com/RoyWallace/BottomNavigationBar) ★253 - MD更新的BottomNavigationbar的开源实现 
- [BottomNavBar](https://github.com/adib2149/BottomNavBar) ★137 - 轻松添加四个选项卡的导航栏 

## Toast 

- [Toasty](https://github.com/GrenderG/Toasty) ★2623 - 通常的Toast 
- [SuperToasts](https://github.com/JohnPersano/SuperToasts) ★2269 - 增强并创建立Android Toast库 
- [TastyToast](https://github.com/yadav-rahul/TastyToast) ★1461 - 精致的原生安卓toast 
- [loadtoast](https://github.com/code-mc/loadtoast) ★1244 - Android可自定义toast 
- [StyleableToast](https://github.com/Muddz/StyleableToast) ★1087 - 标准安卓Toast 
...
- [CreditSesameRingView](https://github.com/HotBitmapGG/CreditSesameRingView) ★923 - 仿Ali芝麻信用新老环形界面 
- [CreditCardView](https://github.com/sharish/CreditCardView) ★708 - 支付系统信用卡和签账卡视图 
- [CreditCardView](https://github.com/vinaygaba/CreditCardView) ★588 - 仿真信用卡UI安卓库 
- [SwipeableCard](https://github.com/michelelacorte/SwipeableCard) ★584 - 仿StreetView磁卡实现 
- [CreditCardEntry](https://github.com/dbachelder/CreditCardEntry) ★454 - 进行信用卡输入的表单 
- [android-sumbit-credit-card-flow](https://github.com/adonixis/android-sumbit-credit-card-flow) ★409 - MD风格的信用卡格式实现 
- [EditCard](https://github.com/Morxander/EditCard) ★78 - 输入信用卡号码的自定义EditText 
- [CardForm](https://github.com/geeckmc/CardForm) ★23 - Android信用卡借记卡互动表单 

## ActionSheet 

- [SlideBottomPanel](https://github.com/kingideayou/SlideBottomPanel) ★679 - 实现知乎日报β版底部划出视图 
- [android-ActionSheet](https://github.com/baoyongzhang/android-ActionSheet) ★653 - 仿照iOS UIActionSheet组件 
- [TedBottomPicker](https://github.com/ParkSangGwon/TedBottomPicker) ★582 - 简单的图片选择器 
- [BottomSheet](https://github.com/Kennyc1012/BottomSheet) ★505 - 安卓BottomSheet风格的对话框 
- [BottomSheets](https://github.com/android-cjj/BottomSheets) ★332 - BottomSheets控件的使用 
- [BottomDialogDemo](https://github.com/SpikeKing/BottomDialogDemo) ★204 - 使用 DialogFragment 实现底部弹窗布局 

## Wave 

- [WaveLoading](https://github.com/race604/WaveLoading) ★1070 - 能够提供波浪动画的Drawable 
- [WaveView](https://github.com/john990/WaveView) ★996 - Android波浪视图 
- [WaveView](https://github.com/gelitenight/WaveView) ★931 - 显示波浪效果的视图 
- [WaveView](https://github.com/1139618418/WaveView) ★107 - 有趣的水波纹效果的界面 
- [RippleLayout](https://github.com/SouthernBox/RippleLayout) ★60 - 使用 drawBitmapMesh 实现仿真水波纹效果 
- [DiffuseView](https://github.com/Airsaid/DiffuseView) ★26 - 自定义的圆形扩散View 
- [DxWaveRefresh](https://github.com/StevenDXC/DxWaveRefresh) ★25 - 波浪效果的下拉刷新 
- [BitmapWaveView](https://github.com/AndroidMsky/BitmapWaveView) ★17 - 在bitmap中显示进度波浪 

## Snackbar 

- [TSnackBar](https://github.com/AndreiD/TSnackBar) ★605 - 从顶部显示一个Snackbar 
- [SnackbarUtils](https://github.com/HuanHaiLiuXin/SnackbarUtils) ★375 - Snackbar工具类 
- [CookieBar](https://github.com/liuguangqiang/CookieBar) ★343 - 屏幕的底部或者顶部显示短信息 
- [Snacky](https://github.com/matecode/Snacky) ★332 - 在布局中添加Snackbar 
- [Light](https://github.com/TonnyL/Light) ★170 - 更好的Snackbar实现 
- [SweetTips](https://github.com/HuanHaiLiuXin/SweetTips) ★59 - 快意灵动的提示库 

## 用户引导 

- [TapTargetView](https://github.com/KeepSafe/TapTargetView) ★2615 - 用户引导功能的实现 
- [TourGuide](https://github.com/worker8/TourGuide) ★2043 - 应用使用方法指导视图 
- [AndroidPdfViewer](https://github.com/barteksc/AndroidPdfViewer) ★1910 - Android中显示PDF文档的库 
- [SlidingTutorial-Android](https://github.com/Cleveroad/SlidingTutorial-Android) ★1851 - Android滑动引导页库 
- [MaterialShowcaseView](https://github.com/deano2390/MaterialShowcaseView) ★1744 - MD主题的ShowcaseView 
- [Highlight](https://github.com/hongyangAndroid/Highlight) ★1720 - app指向性功能高亮的库 
- [MaterialIntroView](https://github.com/iammert/MaterialIntroView) ★1656 - 给 Android 应用添加用户引导 
- [material-intro](https://github.com/HeinrichReimer/material-intro) ★1152 - 简单的MD风格的应用介绍页 
- [Tutors](https://github.com/Popalay/Tutors) ★74 - 种显示用户界面教程 
- [XAnimLayout](https://github.com/limedroid/XAnimLayout) ★18 - 轻松实现引导页动画 

## Popup 

- [BubbleLayout](https://github.com/MasayukiSuda/BubbleLayout) ★543 - 气泡文字框 
- [BubbleView](https://github.com/cpiz/BubbleView) ★485 - 带箭头的Android气泡控件/容器类 
- [CustomPopwindow](https://github.com/pinguo-zhouwei/CustomPopwindow) ★209 - PopupWindow 的常用API封装 

## 滑动返回 

- [Slidr](https://github.com/r0adkll/Slidr) ★1414 - 滑动消失功能 
- [SwipeBack](https://github.com/liuguangqiang/SwipeBack) ★1070 - 使用手势完成Activity 
- [SwipeBackHelper](https://github.com/Jude95/SwipeBackHelper) ★977 - 仿微信下级activity联动效果 
- [and_swipeback](https://github.com/XBeats/and_swipeback) ★739 - 利用滑动手势退出当前Activity 
- [SlideBack](https://github.com/oubowu/SlideBack) ★667 - 高仿微信视差手势滑动返回库 
- [BGASwipeBackLayout-Android](https://github.com/bingoogolapple/BGASwipeBackLayout-Android) ★644 - 实现滑动返回布局 
- [SwipeBack](https://github.com/sockeqwe/SwipeBack) ★595 - 滑动回退功能 
- [SwipeBackFragment](https://github.com/YoKeyword/SwipeBackFragment) ★324 - 滑动Fragment或Activity边缘拖动返回 
- [KugouLayout](https://github.com/zhaozhentao/KugouLayout) ★293 - 模仿酷狗播放器滑动返回的layout 

## TV组件 

- [TVSample](https://github.com/hejunlin2013/TVSample) ★528 - 仿泰捷视频最新TV版 Metro UI 
- [LivePlayback](https://github.com/hejunlin2013/LivePlayback) ★459 - Android TV直播电视节目 
- [TvWidget](https://github.com/evilbinary/TvWidget) ★288 - tv常用效果控件 
- [CustomTvRecyclerView](https://github.com/songwenju/CustomTvRecyclerView) ★37 - 针对Android Tv Launcher页的recyclerView 
- [EpisodeListView](https://github.com/hejunlin2013/EpisodeListView) ★22 - Android剧集列表控件 

## 软键盘 

- [JKeyboardPanelSwitch](https://github.com/Jacksgong/JKeyboardPanelSwitch) ★2052 - 键盘面板冲突及布局闪动处理方案 
- [InputMethodHolder](https://github.com/pqpo/InputMethodHolder) ★276 - 监听系统软键盘的状态 
- [HideKeyboard](https://github.com/yingLanNull/HideKeyboard) ★207 - 自动隐藏软键盘 
- [FloatingKeyboard](https://github.com/GeorgeArgyrakis/FloatingKeyboard) ★81 - 浮动可拖拽的KeyboardView 
...
- [KeyHide](https://github.com/Hamadakram/KeyHide) ★30 - 隐藏Android键盘的简单方法 
- [KeyboardView](https://github.com/GitPhoenix/KeyboardView) ★21 - 自定义安全键盘 

## 状态栏 

- [StatusBarUtil](https://github.com/laobie/StatusBarUtil) ★3196 - 为Android应用设置状态栏 
- [StatusBarCompat](https://github.com/niorgai/StatusBarCompat) ★1284 - Android 沉浸式状态栏 
- [FlycoSystemBar](https://github.com/H07000223/FlycoSystemBar) ★848 - SystemBar助手 
- [ImmersionBar](https://github.com/gyf-dev/ImmersionBar) ★121 - android沉浸式实现 

## StepView 

- [StepView](https://github.com/baoyachi/StepView) ★2457 - 步骤指示器 
- [stepper-indicator](https://github.com/badoualy/stepper-indicator) ★1024 - 引导步骤指示器 
- [android-material-stepper](https://github.com/stepstone-tech/android-material-stepper) ★952 - 在Android应用中使用MD步进 
- [Steppers](https://github.com/drozdzynski/Steppers) ★705 - Android步骤视图库 
- [BreadcrumbsView](https://github.com/VictorAlbertos/BreadcrumbsView) ★559 - 显示给定序列的当前步骤 
- [Android-SnappingStepper](https://github.com/saiwu-bigkoo/Android-SnappingStepper) ★190 - 漂亮的增减数字控制UI控件 
- [StepView](https://github.com/zhangxuyang321/StepView) ★163 - 横向版和竖向版步骤视图 
- [StateProgressView](https://github.com/liuhaizhu/StateProgressView) ★12 - 显示网购物流信息等进度的android view 

## 表格(Table) 

- [excelPanel](https://github.com/zhouchaoyuan/excelPanel) ★1271 - 仿Excel表格的RecyclerView 
- [ScrollablePanel](https://github.com/Kelin-Hong/ScrollablePanel) ★1250 - 二维RecyclerView 
- [AdaptiveTableLayout](https://github.com/Cleveroad/AdaptiveTableLayout) ★1119 - 读取和写入CSV文件 
- [SortableTableView](https://github.com/ISchwarz23/SortableTableView) ★715 - 提供TableView和SortableTableView的安卓库 
- [TableFixHeaders](https://github.com/InQBarna/TableFixHeaders) ★658 - 带有标题的表格的安卓部件 
- [BiDirTable](https://github.com/lungerWang/BiDirTable) ★29 - 可双向滑动的表格 
- [LockTableView](https://github.com/RmondJone/LockTableView) ★13 - Android自定义表格 
- [HVScrollListView](https://github.com/andjdk/HVScrollListView) ★6 - 实现横纵滑动的列表控件 

## 滚动视差(Parallex) 

- [Parallax-Layer-Layout](https://github.com/SchibstedSpain/Parallax-Layer-Layout) ★759 - Android分层视差效果 
- [ParallaxEverywhere](https://github.com/Narfss/ParallaxEverywhere) ★617 - 视差效果的另类Android视图库 
- [ScrollParallaxImageView](https://github.com/gjiazhe/ScrollParallaxImageView) ★400 - 滚动视差效果 
- [linkScrollMsky](https://github.com/AndroidMsky/linkScrollMsky) ★60 - 仿知乎个人主页渐隐嵌套滑动 
- [ParallaxViewPager](https://github.com/demoNo/ParallaxViewPager) ★55 - 带视差效果的简单ViewPager 

## SideBar 

- [RecyclerViewFastScroller](https://github.com/danoz73/RecyclerViewFastScroller) ★883 - 连接到RecyclerView实现快速滚动 
- [SideBar](https://github.com/kongnanlive/SideBar) ★762 - 全新的快速索引导航栏 
- [WaveSideBar](https://github.com/Solartisan/WaveSideBar) ★738 - 快速跳跃分组的侧边栏控件 
- [WaveSideBar](https://github.com/gjiazhe/WaveSideBar) ★682 - 波浪效果索引侧边栏 
- [FastScroll](https://github.com/L4Digital/FastScroll) ★529 - 类似列表视图的FastScroller 
- [Android-QuickSideBar](https://github.com/saiwu-bigkoo/Android-QuickSideBar) ★391 - 快速查阅对应分组的侧边栏 

## 关于页面 

- [AboutLibraries](https://github.com/mikepenz/AboutLibraries) ★1760 - 提供库信息的库 
- [Android About Page](https://github.com/medyo/android-about-page) ★1244 - 快速创建独一无二的About页面 
- [MaterialAbout](https://github.com/jrvansuita/MaterialAbout) ★799 - 显示一个MD风格的about页面 
- [material-about-library](https://github.com/daniel-stoneuk/material-about-library) ★756 - 为app轻松创建关于页面 
- [about-page](https://github.com/drakeet/about-page) ★93 - 基于MultiType的about页面 
- [LSettingView](https://github.com/leonHua/LSettingView) ★44 - 设置界面条目封装 

## 详情页 

- [SlideDetailsLayout](https://github.com/cnbleu/SlideDetailsLayout) ★254 - 上拉加载图文详情功能 
- [DragScrollDetailsLayout](https://github.com/happylishang/DragScrollDetailsLayout) ★241 - 仿淘宝京东蘑菇街商品详情页 
- [GoodsInfoPage](https://github.com/hexianqiao3755/GoodsInfoPage) ★199 - 仿京东天猫app的商品详情页 
- [LongPressPopup](https://github.com/RiccardoMoro/LongPressPopup) ★191 - 长按显示详细信息 
- [article-android](https://github.com/klinker41/article-android) ★89 - 以可读格式显示web文章 
- [NewsDetail](https://github.com/iceAnson/NewsDetail) ★61 - 仿今日头条详情页实现 
...
- [FloatingActionButton](https://github.com/Clans/FloatingActionButton) ★3164 - 浮动动作按钮 
- [material-sheet-fab](https://github.com/gowong/material-sheet-fab) ★1244 - 实现浮动操作按钮的库 
- [FabOptions](https://github.com/JoaquimLey/FabOptions) ★810 - 多功能自定义FAB组件 
- [Floating-Navigation-View](https://github.com/andremion/Floating-Navigation-View) ★792 - 浮动菜单显示锚导航视图 
- [FabTransitionLayout](https://github.com/bowyer-app/FabTransitionLayout) ★428 - 浮动操作按钮转换 
- [SquareMenu](https://github.com/devsideal/SquareMenu) ★405 - 可自定义的浮动动作按钮 
- [CounterFab](https://github.com/andremion/CounterFab) ★358 - 在右上角显示一个计数器的标记 

## Indicator 

- [SpringIndicator](https://github.com/chenupt/SpringIndicator) ★1860 - 仿MorningRoutine引导的指示器 
- [AndroidRubberIndicator](https://github.com/LyndonChin/AndroidRubberIndicator) ★1396 - ViewPager的rubber指示器 
- [EasyIndicator](https://github.com/LuckSiege/EasyIndicator) ★48 - 简单的tab指示器 

## 分享组件 

- [ShareUtil](https://github.com/shaohui10086/ShareUtil) ★819 - 综合性的分享及登录工具库 
- [ShareButton](https://github.com/kayan1990/ShareButton) ★445 - 一个具有流畅动画的分享按钮 
- [GeneratePicture](https://github.com/zhangke3016/GeneratePicture) ★128 - 选取页面内容生成精美分享图片 

## 升级更新 

- [update](https://github.com/czy1121/update) ★890 - 清晰灵活简单易用的应用更新库 
- [UpdatePlugin](https://github.com/yjfnypeu/UpdatePlugin) ★688 - 自由定制的app更新组件 
- [android-auto-update](https://github.com/feicien/android-auto-update) ★517 - 安卓应用自动更新库 
- [AppUpdate](https://github.com/fccaikai/AppUpdate) ★103 - Android 检查更新库 
- [BGAUpdate-Android](https://github.com/bingoogolapple/BGAUpdate-Android) ★87 - 应用更新功能 
- [CheckUpdateLibrary](https://github.com/qiangxi/CheckUpdateLibrary) ★68 - Android专用检查软件更新的库 
- [BackgroundUpdate](https://github.com/wenwenwen888/BackgroundUpdate) ★28 - 后台更新APP 

## Toolbar 

- [FloatingToolbar](https://github.com/rubensousa/FloatingToolbar) ★1127 - FloatingActionButton变形而来的工具栏 
- [morphy-toolbar](https://github.com/badoualy/morphy-toolbar) ★966 - 切换fragments的精致过渡动画 
- [material-cab](https://github.com/afollestad/material-cab) ★759 - 自定义的灵活上下文活动栏 
- [ByeBurger](https://github.com/githubwing/ByeBurger) ★712 - 极其简便的快速实现隐藏标题栏和导航栏 
- [android-animated-menu-items](https://github.com/adonixis/android-animated-menu-items) ★685 - toolbar中动画菜单条目的示例 
- [AwesomeBar](https://github.com/florent37/AwesomeBar) ★491 - 优美的侧边工具菜单 
- [CollapsingToolbar-With-Webview](https://github.com/RameshBhupathi/CollapsingToolbar-With-Webview) ★186 - 带有可折叠toolbar的Webview 
- [SlideshowToolbar](https://github.com/JuL1205/SlideshowToolbar) ★185 - 安卓Slideshow Toolbar 
...
- [SortableTableView](https://github.com/ISchwarz23/SortableTableView) ★715 - 提供TableView和SortableTableView的安卓库 
- [ClassifyView](https://github.com/AlphaBoom/ClassifyView) ★295 - 拖拽合并的RecyclerView 
- [android-drag-square](https://github.com/SwiftyWang/android-drag-square) ★210 - 编辑个人资料及图片可拖拽排序 

## Emoji 

- [emojicon](https://github.com/rockerhieu/emojicon) ★2731 - Android中实现emojis表情 
- [EmojiRain](https://github.com/Luolc/EmojiRain) ★502 - 小巧的Android掉emoji表情包实现 
- [android-EmojiCompat](https://github.com/googlesamples/android-EmojiCompat) ★68 - EmojiCompat支持库使用样例 

## Label 

- [labelview](https://github.com/linger1216/labelview) ★1349 - 轻松实现视图之上的标签 
- [TriangleLabelView](https://github.com/shts/TriangleLabelView) ★587 - 显示三角视图 
- [AvatarLabelView](https://github.com/yanbober/AvatarLabelView) ★413 - 可配置的迷你版轻量级 Label 辅助类 
...
- [WheelView-Android](https://github.com/lantouzi/WheelView-Android) ★866 - 具有轮视图的选择器 
- [HorizontalWheelView](https://github.com/shchurov/HorizontalWheelView) ★811 - 供用户输入的模型水平轮控制器 
- [WheelView](https://github.com/LukeDeighton/WheelView) ★696 - 实现一个可旋转的轮盘 
- [androidWheelView](https://github.com/weidongjian/androidWheelView) ★591 - 仿照iOS的滚轮控件 
- [CursorWheelLayout](https://github.com/BCsl/CursorWheelLayout) ★489 - 把视图放到一个可旋转轮子中 

## PinCode 

- [LolliPin](https://github.com/OrangeGangsters/LolliPin) ★1150 - MD风格的Android的PIN码库 
- [PatternLockView](https://github.com/aritraroy/PatternLockView) ★1111 - MD风格的Android解锁视图 
- [PinLockView](https://github.com/aritraroy/PinLockView) ★789 - PIN锁自定义视图 
- [Pinview](https://github.com/GoodieBag/Pinview) ★412 - Android的Pinview库 
- [PasscodeView](https://github.com/kevalpatel2106/PasscodeView) ★143 - 轻松安全的验证用户 
- [PasscodeView](https://github.com/hanks-zyh/PasscodeView) ★101 - Android查看视图 
- [EasyGestureUnlock](https://github.com/huzenan/EasyGestureUnlock) ★19 - 轻量级手势解锁视图 

## CoordinatorLayout 

- [CoordinatorBehaviorExample](https://github.com/saulmm/CoordinatorBehaviorExample) ★2001 - 仿Hangouts4简介动画 
- [TabbedCoordinatorLayout](https://github.com/vitovalov/TabbedCoordinatorLayout) ★667 - 演示CoordinatorLayout的示例项目 
- [android-ConstraintLayoutExamples](https://github.com/googlesamples/android-ConstraintLayoutExamples) ★357 - 展示ContraintLayout的特性和使用 
- [SharePanel](https://github.com/architjn/SharePanel) ★49 - 显示分享按钮面板 
- [collapsingtoolbarlayout](https://github.com/Liuncoolman/collapsingtoolbarlayout) ★14 - 可滑动悬浮式顶部导航栏 

## 页面切换 

- [TransitionPlayer](https://github.com/linfaxin/TransitionPlayer) ★1140 - 控制过渡动画的Android库 
- [android-PageFlip](https://github.com/eschao/android-PageFlip) ★1111 - 3D风格页面翻页 
- [EasyFlipView](https://github.com/wajahatkarim3/EasyFlipView) ★657 - 快速而简单的翻转视图 
- [magellan](https://github.com/wealthfront/magellan) ★276 - 最简单的Android导航库 
- [TranslationCompat](https://github.com/zhangke3016/TranslationCompat) ★108 - 动画过渡兼容库 

## 悬浮窗 

- [FloatUtil](https://github.com/liuguangli/FloatUtil) ★148 - 简单的浮窗工具 
- [NetSpeed](https://github.com/mrrobot97/NetSpeed) ★34 - 悬浮窗网速显示计 

## 地图 

- [MapView](https://github.com/onlylemi/MapView) ★488 - 室内地图视图 
- [ThemedGoogleMap](https://github.com/jineshfrancs/ThemedGoogleMap) ★158 - 创建带自定义主题的GoogleMap的实用类 
- [DrawRouteMaps](https://github.com/ar-android/DrawRouteMaps) ★156 - 路线地图功能 
- [android-togetherMap](https://github.com/yipianfengye/android-togetherMap) ★30 - 高德地图的marker聚合功能 

## 编辑器 

- [MarkdownView](https://github.com/falnatsheh/MarkdownView) ★706 - Android的Markdown 
- [MarkdownView](https://github.com/tiagohm/MarkdownView) ★563 - 显示Markdown文本的Android库 
...
- [PreviewSeekBar](https://github.com/rubensousa/PreviewSeekBar) ★1869 - 显示视频预览的SeekBar 
- [BubbleSeekBar](https://github.com/woxingxiao/BubbleSeekBar) ★875 - 自定义SeekBar 
- [RangeSeekBar](https://github.com/Jay-Goo/RangeSeekBar) ★107 - 可双向范围选择的SeekBar 
- [RangeSeekBar](https://github.com/Brioal/RangeSeekBar) ★26 - 定值范围选择控件 

## DownloadView 

- [GADownloading](https://github.com/Ajian-studio/GADownloading) ★723 - 创意下载进度条 
- [FreshDownloadView](https://github.com/dudu90/FreshDownloadView) ★615 - 显示一个动画下载进程 
- [360DownLoadView](https://github.com/Metal626/360DownLoadView) ★27 - 仿360市场下载按钮 

## 其他 

- [Shimmer](https://github.com/facebook/Shimmer) ★7810 - 闪光效果插件 
- [Android Bootstrap](https://github.com/Bearded-Hen/Android-Bootstrap) ★5962 - Bootstrap风格安卓主题 
- [litho](https://github.com/facebook/litho) ★3200 - 创建Android高效UI 
- [flow](https://github.com/square/flow) ★2249 - 命名UI状态 
- [QuickReturn](https://github.com/lawloretienne/QuickReturn) ★1460 - 展示QuickReturn UI 模块 
- [ENViews](https://github.com/codeestX/ENViews) ★1445 - 华丽丽的动效控件库 
- [FloatingView](https://github.com/UFreedom/FloatingView) ★1172 - 使目标视图漂浮在锚视图上 
- [SmoothCheckBox](https://github.com/andyxialm/SmoothCheckBox) ★1056 - Android带动画的自定义CheckBox 
- [ArcLayout](https://github.com/ogaclejapan/ArcLayout) ★1023 - 非常简单的arc布局库 
- [CouponView](https://github.com/dongjunkun/CouponView) ★990 - 优惠券效果 
- [android-PictureInPicture](https://github.com/googlesamples/android-PictureInPicture) ★970 - 演示手持设备画中画模式 
- [BigBang](https://github.com/baoyongzhang/BigBang) ★898 - 仿了Smartisan OS 的 BigBang 功能 
- [Crescento](https://github.com/developer-shivam/Crescento) ★892 - 图像视图和相关布局的下面添加曲线 
- [ScratchView](https://github.com/sharish/ScratchView) ★864 - 仿刮刮卡视图 
- [ChromeLikeTabSwitcher](https://github.com/michael-rapp/ChromeLikeTabSwitcher) ★763 - 标签切换器 
- [Android-ExpandIcon](https://github.com/zagum/Android-ExpandIcon) ★735 - Google风格上下箭头的简单自定义实现 
- [android-snowfall](https://github.com/JetradarMobile/android-snowfall) ★718 - 安卓Snowfall View的全自定义实现 
- [QQBubbleView](https://github.com/Yasic/QQBubbleView) ★713 - 仿QQ空间直播礼物冒泡特效 
- [StickerView](https://github.com/wuapnjie/StickerView) ★705 - 贴纸视图的缩放拖动翻转删除 
- [FloatingView](https://github.com/recruit-lifestyle/FloatingView) ★705 - 显示悬浮窗效果 
- [MathView](https://github.com/kexanie/MathView) ★684 - 在Android应用中显示数学公式 
- [PathAnimView](https://github.com/mcxtzhang/PathAnimView) ★657 - 用于做Path动画的自定义View 
- [3dTagCloudAndroid](https://github.com/misakuo/3dTagCloudAndroid) ★652 - 将一组View展示为一个3D球形集合 
- [Squint](https://github.com/IntruderShanky/Squint) ★633 - 提供视图的对角线裁剪 
- [GABottleLoading](https://github.com/Ajian-studio/GABottleLoading) ★622 - 贝塞尔风暴 
- [ParticleTextView](https://github.com/Yasic/ParticleTextView) ★619 - 用粒子动画显示文字的 Android 自定义 View 
- [FogView_Library](https://github.com/dynamitechetan/FogView_Library) ★579 - 安卓雾气视图库 
- [Isometric](https://github.com/FabianTerhorst/Isometric) ★571 - 安卓图形库 
- [Depth](https://github.com/florent37/Depth) ★558 - 在fragments中添加Depth 
- [LoopRotarySwitch](https://github.com/dalong982242260/LoopRotarySwitch) ★555 - 3d旋转切换view 
- [ScrollNumber](https://github.com/a-voyager/ScrollNumber) ★543 - 简单优雅易用的滚动数字控件 
- [DrawView](https://github.com/ByoxCode/DrawView) ★541 - 提供涂鸦功能 
- [Tangram-Android](https://github.com/alibaba/Tangram-Android) ★540 - 动态化构建Native页面的框架 
- [tooltips](https://github.com/tomergoldst/tooltips) ★526 - 在任何视图上添加工具提示 
- [android-combination-avatar](https://github.com/kongnanlive/android-combination-avatar) ★500 - 模仿QQ讨论组组合头像 
- [Android-Coverflow](https://github.com/crosswall/Android-Coverflow) ★492 - 漂亮的Android封面浏览 
- [Android-DragDismissActivity](https://github.com/klinker24/Android-DragDismissActivity) ★489 - 滑动取消Activity 
- [LyricViewDemo](https://github.com/zhengken/LyricViewDemo) ★485 - 强大灵活的歌词视图 
- [ZDepthShadow](https://github.com/ShogoMizumoto/ZDepthShadow) ★485 - MD风格的安卓拉直深入阴影 
- [PolygonDrawingUtil](https://github.com/stkent/PolygonDrawingUtil) ★479 - 在canvas上绘制规则多边形 
- [EasyCountDownTextureView](https://github.com/CaMnter/EasyCountDownTextureView) ★447 - 使用TextureView轻松实现倒计时 
- [TContributionsView](https://github.com/barryhappy/TContributionsView) ★435 - 显示类似github贡献度的View 
- [LayoutSwitch](https://github.com/gjiazhe/LayoutSwitch) ★419 - 列表布局与网格布局的切换 
- [AppIconNameChanger](https://github.com/myinnos/AppIconNameChanger) ★392 - 动态的改变安卓应用Icon和名称 
- [FreeDrawView](https://github.com/RiccardoMoro/FreeDrawView) ★355 - 一个可以自由涂鸦的视图 
- [ImageCoverFlow](https://github.com/dolphinwang/ImageCoverFlow) ★334 - 图片封面浏览效果 
- [WJMagicCurveView](https://github.com/wingjay/WJMagicCurveView) ★304 - 神奇的魔法曲线 
- [AndroidShortcuts](https://github.com/pcevikogullari/AndroidShortcuts) ★293 - 快捷方式示例app 
- [VerificationCodeView](https://github.com/Freshman111/VerificationCodeView) ★292 - 动态生成验证码 
- [Lemniscate](https://github.com/vlad1m1r990/Lemniscate) ★288 - 制作别致的进度视图 
- [LBehavior](https://github.com/Lauzy/LBehavior) ★278 - 简单实现标题栏导航栏滑动动画 
- [tab-digit](https://github.com/xenione/tab-digit) ★277 - 一个Flip Clock 库 
- [EdgeTranslucent](https://github.com/qinci/EdgeTranslucent) ★274 - 任意View边沿渐变透明 
- [FallingView](https://github.com/DingMouRen/FallingView) ★246 - 实现碎片飘落效果的控件 
- [GooView](https://github.com/smartbetter/GooView) ★244 - 一个自定义粘性控件 
- [ClearScreenHelper](https://github.com/Yellow5A5/ClearScreenHelper) ★244 - 清屏相关的需求 
- [DashboardView](https://github.com/woxingxiao/DashboardView) ★237 - 安卓自定义仪表盘View 
- [jellyball](https://github.com/ImmortalZ/jellyball) ★221 - 高仿 path下拉小球 
- [CrazyShadow](https://github.com/Hitomis/CrazyShadow) ★220 - 为 View 添加阴影效果 
- [CompositionAvatar](https://github.com/YiiGuxing/CompositionAvatar) ★202 - 仿QQ讨论组头像 
- [ChanelView](https://github.com/developer-shivam/ChanelView) ★201 - 说明手势的简单用例 
- [FloatingViewService](https://github.com/hanbaokun/FloatingViewService) ★200 - 一个服务开启悬浮球 
- [SimpleOneStep](https://github.com/gavinliu/SimpleOneStep) ★187 - 仿OneStep 
- [FreeView](https://github.com/jcmore2/FreeView) ★180 - 浮动视图 
- [ShoppingCart](https://github.com/ChyengJason/ShoppingCart) ★178 - 仿饿了么购物车效果 
- [FloatView](https://github.com/AlexLiuSheng/FloatView) ★169 - 类似来电秀的效果 
- [UnifiedContactPicker](https://github.com/quiin/UnifiedContactPicker) ★152 - 统一用户联系人 
- [DragFooterView](https://github.com/uin3566/DragFooterView) ★143 - 向左拖拽跳转至更多页面 
- [FloatBall](https://github.com/HalfStackDeveloper/FloatBall) ★142 - 高仿flyme悬浮球 
- [AndroidGpsStatus](https://github.com/hzw1199/AndroidGpsStatus) ★137 - 显示GPS状态和信号强度 
- [WindView](https://github.com/AhmadNemati/WindView) ★134 - 显示天气风速和压力状态 
- [AttributesDispatcher](https://github.com/pavel163/AttributesDispatcher) ★111 - 创建一个自定义视图 
- [SnapHelperExample](https://github.com/MindorksOpenSource/SnapHelperExample) ★100 - SnapHelper的Android示例 
- [XyzInfo](https://github.com/zhangxuyang321/XyzInfo) ★90 - 自定义Switch和Ruler控件 
...
- [WaitView](https://github.com/ImKarl/WaitView) ★73 - 显示等待加载状态的View 
- [PayUI](https://github.com/a5533348/PayUI) ★69 - 支付密码弹出层 
- [VerificationCodeInput](https://github.com/liuguangli/VerificationCodeInput) ★67 - 简洁验证码输入框 
- [Android-RadarView](https://github.com/jeanboydev/Android-RadarView) ★62 - 仿支付宝芝麻分解读 
...
- [ShelfView](https://github.com/tdscientist/ShelfView) ★57 - 显示书架上的书的自定义视图 
...
- [RuleView](https://github.com/panacena/RuleView) ★46 - 自定义刻度尺控件 
- [PaintView](https://github.com/LiuHongtao/PaintView) ★42 - 在图片上涂鸦 
- [DigitSpeedView](https://github.com/capur16/DigitSpeedView) ★39 - 独特的安卓数字测速仪 
- [NetMonitor](https://github.com/GHdeng/NetMonitor) ★39 - 使用广播监听网络变化 
- [StickyDemo](https://github.com/wobiancao/StickyDemo) ★38 - 三步实现控件悬浮 
- [checkview](https://github.com/cdflynn/checkview) ★36 - 动画check标记 
- [Particle](https://github.com/JadynAi/Particle) ★32 - 一个android萤火虫飞舞的粒子效果 
- [BubbleView](https://github.com/simplepeng/BubbleView) ★29 - 模仿QQ水泡拖拽效果 
- [CircleRangeView](https://github.com/WangGanxin/CircleRangeView) ★26 - 自定义圆形仪表盘View 
...
- [HoverView](https://github.com/fashare2015/HoverView) ★20 - 仿知乎的底部抽屉 
- [VerificationCodeView](https://github.com/yongming9011/VerificationCodeView) ★19 - Android简单的验证码控件 
